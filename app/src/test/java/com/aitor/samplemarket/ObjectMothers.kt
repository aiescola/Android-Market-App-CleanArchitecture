...
object DiscountMother {
    val PRODUCT_DISCOUNT = NetworkDiscount("DISCOUNT",
        DiscountType.PRODUCT.value,
        "PRODUCT_DISCOUNT",
        "description",
        listOf("PRODUCT_TEST_ID"),
        99.99)
    val BULK_DISCOUNT = NetworkDiscount("DISCOUNT",
        ...
        minAmount = 99,
        pct = 9)
    val PROMOTION_DISCOUNT = NetworkDiscount("DISCOUNT",
...
object ProductMother {
    val listOfProducts = listOf(Product("mock1", "aa", 4.0),
    ...
    val PRODUCTS_UPDATE =
        NetworkProductsAnswer(listOf(NetworkProduct("PRODUCT_TEST_ID", "mock1", 5.0)))
}

object NetworkProductMother {
    val networkProducts = listOf(NetworkProduct("test code", "test name", 3.0),
        NetworkProduct("test code 2", "test name 2", 4.0))
}